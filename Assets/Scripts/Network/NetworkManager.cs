...
public class NetworkManager : Singleton<NetworkManager>
{
    ...
    public static string setverIP = "115.159.217.155";
    ...
    {
        NetworkManager.serverURL = "http://115.159.217.155/BeastGame/ServerUrl.html";
    ...
    public void ConnectToServer()
    {
        ...
        UnityMonoDriver.s_instance.StartCoroutine(this.ConnectToURL());
    }
    /// <summary>
    /// 发送消息
    /// </summary>
